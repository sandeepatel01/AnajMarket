...
const CreateProduct = () => {
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            productData.append("sellerContactNo", sellerContactNo);
            productData.append("state", state);
            productData.append("city", city);
            productData.append("sellerAddress", sellerAddres);
                        ...
                        <div className="m-1 w-75">
                            ...
                            <div className="mb-3">
                                <input
                                    ...
                                    placeholder="write seller contact number"
                                    className="form-control"
                            ...
                            <div className="mb-3">
                                <input
                                    type="text"
                                    value={sellerAddres}
                                    placeholder="write seller address"
                                    className="form-control"
                            ...
                            {/* <div className="mb-3">
                                <input
                                    type="text"
                                    value={state}
                                    placeholder="write seller state"
                                    className="form-control"
